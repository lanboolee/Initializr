...
public class InitializrProperties extends InitializrConfiguration {
	 ...
	 */
	@JsonIgnore
	private final SimpleElement groupId = new SimpleElement("com.choice.cloud");
	 ...
	 */
	@JsonIgnore
	private final SimpleElement name = new SimpleElement("initializr");
	 ...
	 */
	@JsonIgnore
	private final SimpleElement packageName = new SimpleElement("com.choice.cloud");
